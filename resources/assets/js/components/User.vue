                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      ...
                                      <option value="personas.num_documento">Documento</option>
                                      <option value="personas.email">Email</option>
                                      <option value="personas.telefono">Teléfono</option>
                                    </select>
    ...
    export default {
        ...
        methods : {
            listarPersona (page,buscar,criterio){
                let me=this;
                var url= '/user?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio+'&roles='+this.roles;
            ...
            validarPersona(){
                ...
                if (!this.apellidos) this.errorMostrarMsjPersona.push("El apellido de la pesona no puede estar vacío.");
