  ...
  //          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    initFullCalendar: function(){
      ...
      select: function(start, end) { 
                ...
                var check = moment(start).format('YYYY-MM-DD HH:mm');
                ...
                // si no, mostramos una alerta de error
                    ...
                    alert("No se pueden crear citas en fechas y/o horas pasadas.");
                }
                ...
                // var eventData;
                    ...
                    $(document).on('submit', '#create-schedule', function() 
                      { 
                          ...
                          $.ajax({  
                              ...
                              success: function(data) {
                                  ...
                                  // $("#new-schedule").load(" #new-schedule");  
                                  if (data) 
                                  {
                                    console.log('Horario creado');
                                    $('#fullCalendar').fullCalendar('refetchEvents');
                                      // $calendar.fullCalendar('renderEvent', eventData, true);
                                    // $('#fullCalendar').fullCalendar('updateEvents', events );
      ...
      eventClick: function (event, jsEvent, view) {
          ...
          // var con=confirm("Esta seguro que desea eliminar la cita");
          var start = moment(event.start).format("DD-MM-YYYY HH:mm");
          $('#id_horario').val(event.id);
          $('#nombre_medico').val(event.title);
          $('#start').val(start);
          ...
          // if(con){
          //     $.ajax({ 
          //        url: '/admin/pacientes/eliminaEvento',
          //        data: 'id=' + event.id,
          //        headers: {
          //           "X-CSRF-TOKEN": crsfToken
          //         },
